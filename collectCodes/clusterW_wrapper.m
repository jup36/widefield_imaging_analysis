...
% save
save(fullfile(fileSaveDir, 'clusterW_input_CAmotifs'), 'wC', 'nanpxsC', 'idC', 'skippedFiles', '-v7.3'); % Also backup at '/Volumes/buschman/Rodent Data/dualImaging_parkj/motif_data_backup'
...
save(fullfile(fileSaveDir, 'clusterW_input_CAmotifs'), 'wCV', 'nanpxsCV', 'is_equal_nanpxsC', '-append', '-v7.3'); % Also backup at '/Volumes/buschman/Rodent Data/dualImaging_parkj/motif_data_backup'
...
opts.clust_removepad=1; % to remove temporal padding (10 frames before and after)
[W_basisC, kval, ovr_q, cluster_idxC, idx_knn, tcorr_mat, handles, lag_mat, lags, nanpxs, shiftC] = ClusterW_multiLevels(wCV, gp, nanpxsCV{1}); 

% temporarily save ClusterW output
save(fullfile(fileSaveDir, 'clusterW_output_CAmotifs'), 'W_basisC', 'kval', 'ovr_q', 'cluster_idxC', 'idx_knn', 'tcorr_mat', 'lag_mat', 'lags', 'nanpxs', 'shiftC', '-v7.3');
