...
save(fullfile(fileSaveDir, 'clusterW_input_CAmotifs'), 'wCV', 'nanpxsCV', 'is_equal_nanpxsC', '-append'); % Also backup at '/Volumes/buschman/Rodent Data/dualImaging_parkj/motif_data_backup'
...
save(fullfile(fileSaveDir, 'clusterW_output_CAmotifs'), 'W_basisC', 'W_aligned', 'kval', 'ovr_q', 'cluster_idxC', 'idx_knn', 'tcorr_mat', 'lag_mat', 'lags', 'nanpxs', 'shiftC', '-v7.3');
