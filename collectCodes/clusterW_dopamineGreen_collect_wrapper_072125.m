...
save(fullfile(fileSaveDir, 'clusterW_output_DAmotifs_072125.mat'), 'W_basisC', 'W_aligned', 'kval', 'ovr_q', 'cluster_idxC', 'idx_knn', 'tcorr_mat', 'lag_mat', 'lags', 'nanpxs', 'shiftC', '-v7.3');
