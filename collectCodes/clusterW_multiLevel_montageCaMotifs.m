...
load(fullfile(fileSaveDir, 'clusterW_output_CAmotifs_072125'), 'W_basisC', 'kval', 'ovr_q', 'cluster_idxC', 'idx_knn', 'tcorr_mat', 'lag_mat', 'lags', 'nanpxs', 'shiftC');

%% montage and print
W = W_basisC{1,2}; 

montageMotifsPrint(W, nanpxs, 10, 1)
