...
[mHitDffFirstLick_early, sHitDffFirstLick_early, ~, hitDffFirstLick_early_ts] = getInterpolatedMeanSemDffFromDffTsCell(rez1.hitDffFirstLick.m1, [-1 1]);
[mHitDffFirstLick_late, sHitDffFirstLick_late, ~, hitDffFirstLick_late_ts] = getInterpolatedMeanSemDffFromDffTsCell(rez2.hitDffFirstLick.m1, [-1 1]);
...
print(fullfile(figSaveDir, strcat(mouseId1, '_', date1, '_', date2, '_dff_lick_Hit_early_late_m1.pdf')), '-dpdf', '-vector', '-bestfit')
