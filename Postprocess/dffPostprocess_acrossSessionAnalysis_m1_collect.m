...
print(fullfile(figSaveDir, strcat(mouseIdC{1}, '_dff_cueOnAligned_hit_across_session_M1_fullX')), '-dpdf', '-vector', '-bestfit')
xlim([1 4])
print(fullfile(figSaveDir, strcat(mouseIdC{1}, '_dff_cueOnAligned_hit_across_session_M1')), '-dpdf', '-vector', '-bestfit')
...
print(fullfile(figSaveDir, strcat(mouseIdC{1}, '_dff_hitAligned_hit_across_session_M1')), '-dpdf', '-vector', '-bestfit')
