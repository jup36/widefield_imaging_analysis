...
meanXcorrDffLick = [norm_mean_xcorrDffLick_m1_hit_C{3}; ...
                    norm_mean_xcorrDffLick_m2_hit_C{3}; ...
                    norm_mean_xcorrDffLick_ss_hit_C{3}; ...
                    norm_mean_xcorrDffLick_rs_hit_C{3}; ...
                    norm_mean_xcorrDffLick_v1_hit_C{3}]; 

semXcorrDffLick = [norm_sem_xcorrDffLick_m1_hit_C{3}; ...
                    norm_sem_xcorrDffLick_m2_hit_C{3}; ...
                    norm_sem_xcorrDffLick_ss_hit_C{3}; ...
                    norm_sem_xcorrDffLick_rs_hit_C{3}; ...
                    norm_sem_xcorrDffLick_v1_hit_C{3}]; 
