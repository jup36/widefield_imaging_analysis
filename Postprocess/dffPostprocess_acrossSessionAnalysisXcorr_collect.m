...
hold off;
ylim([0 0.21])
print(fullfile(figSavePath, 'xcorr_Gng_lick_dff_xcorrSymInd_acrossSessionRegion.pdf'), '-dpdf', '-vector', '-bestfit')


%% plot xcorr across regions day4
meanXcorrDffLick = [norm_mean_xcorrDffLick_m1_hit_C{4}; ...
                    norm_mean_xcorrDffLick_m2_hit_C{4}; ...
                    norm_mean_xcorrDffLick_ss_hit_C{4}; ...
                    norm_mean_xcorrDffLick_rs_hit_C{4}; ...
                    norm_mean_xcorrDffLick_v1_hit_C{4}]; 

semXcorrDffLick = [norm_sem_xcorrDffLick_m1_hit_C{4}; ...
                    norm_sem_xcorrDffLick_m2_hit_C{4}; ...
                    norm_sem_xcorrDffLick_ss_hit_C{4}; ...
                    norm_sem_xcorrDffLick_rs_hit_C{4}; ...
                    norm_sem_xcorrDffLick_v1_hit_C{4}]; 

xcorrFig = plotMeanSemColorC(meanXcorrDffLick, semXcorrDffLick, -2:0.001:2, colorC, {'M1', 'M2', 'SS', 'RS', 'V1'}); 
xlabel('Time (s)'); ylabel('xcorr'); set(gca, 'TickDir', 'out', 'XTick', -2:1:2); grid on
print(fullfile(figSavePath, strcat(mouseIdC{1}, '_', dateC{3}, '_xcorr_dff_lick_acrossRegions.pdf')), '-dpdf', '-vector', '-bestfit')
close(xcorrFig)

%% plot xcorr across regions day1
meanXcorrDffLick = [norm_mean_xcorrDffLick_m1_hit_C{1}; ...
                    norm_mean_xcorrDffLick_m2_hit_C{1}; ...
                    norm_mean_xcorrDffLick_ss_hit_C{1}; ...
                    norm_mean_xcorrDffLick_rs_hit_C{1}; ...
                    norm_mean_xcorrDffLick_v1_hit_C{1}]; 

semXcorrDffLick = [norm_sem_xcorrDffLick_m1_hit_C{1}; ...
                    norm_sem_xcorrDffLick_m2_hit_C{1}; ...
                    norm_sem_xcorrDffLick_ss_hit_C{1}; ...
                    norm_sem_xcorrDffLick_rs_hit_C{1}; ...
                    norm_sem_xcorrDffLick_v1_hit_C{1}]; 

xcorrFig = plotMeanSemColorC(meanXcorrDffLick, semXcorrDffLick, -2:0.001:2, colorC, {'M1', 'M2', 'SS', 'RS', 'V1'}); 
xlabel('Time (s)'); ylabel('xcorr'); set(gca, 'TickDir', 'out', 'XTick', -2:1:2); grid on
print(fullfile(figSavePath, strcat(mouseIdC{1}, '_', dateC{1}, '_xcorr_dff_lick_acrossRegions.pdf')), '-dpdf', '-vector', '-bestfit')
close(xcorrFig)
