function dffPostprocessAuditoryGng_averaging_rs_dual(filePath, channel)
...
print(fullfile(filePath, 'Figure', strcat('xcorr_Gng_lick_dff_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(xcorrFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_Gng_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnFig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_HitCr_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_HitFA_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_MissCR_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_FaCR_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnFaCrFig)
fprintf("Saved tone(stim)-aligned dff plot comparing Miss vs CR!\n")
...
% figure; plot(rezRS.stimOnGoNogoSvmTs, mean(rezRS.stimOnGoNogoSvm))
...
% figure; plot(rezRS.stimOnHitCrSvmTs, mean(rezRS.stimOnHitCrSvm))
...
% figure; plot(rezRS.stimOnHitFaSvmTs, mean(rezRS.stimOnHitFaSvm))
...
% figure; plot(rezRS.stimOnHitMissSvmTs, mean(rezRS.stimOnHitMissSvm))

% rs (stim onset) Miss vs CR (train classifier)
...
% figure; plot(rezRS.stimOnMissCrSvmTs, mean(rezRS.stimOnMissCrSvm))
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); %ylim([-.3 .3])
print(fullfile(filePath, 'Figure', strcat('dff_postStimLick_Gng_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
print(fullfile(filePath, 'Figure', strcat('dff_hitFirstLick_Gng_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(hitFstLickFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_firstWater_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(firstWaterFig)
...
if isfield(rez, 'firstAirpuff')
    ...
    print(fullfile(filePath, 'Figure', strcat('dff_firstAirpuff_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
    close(fstAirFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_faFstLickFig_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(faFstLickFig)
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); grid on
print(fullfile(filePath, 'Figure', strcat('dff_lick_Hit_Fa_postStim_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); grid on
print(fullfile(filePath, 'Figure', strcat('dff_lick_Hit_Fa_postStim_baseSub_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
% figure; plot(rezRS.lickHitFaSvmTs, mean(rezRS.lickHitFaSvm))
...
clim([-0.5 0.5])
print(fullfile(filePath, 'Figure', strcat('dff_hit_timeBin_by_trial_rs_', channel', '.pdf')), '-dpdf', '-vector', '-bestfit')
close(X_hit_fig)

X_fa_fig = imagescWithTimeInfo(smooth2a(X_fa, 0, 1), rezRS.lickHitFaSvmTs); 
set(gca, 'XTick', -2:.5:4, 'TickDir', 'out');
clim([-0.7 0.7])
print(fullfile(filePath, 'Figure', strcat('dff_fa_timeBin_by_trial_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(X_fa_fig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_goMiss_rs_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnMissFig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_nogoCR_rs_', channel, '.pdf'), '-dpdf', '-vector', '-bestfit')
close(stimOnCrFig)
...
%% save rez
save(fullfile(filePath, 'Matfiles', strcat(header, '_dff_evtAligned_regionMask_rs_', channel, '.mat')), 'rezRS');
