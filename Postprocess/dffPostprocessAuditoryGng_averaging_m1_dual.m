function dffPostprocessAuditoryGng_averaging_m1_dual(filePath, channel)
...
print(fullfile(filePath, 'Figure', strcat('xcorr_Gng_lick_dff_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(xcorrFig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out'); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_Gng_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_HitCr_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_HitFA_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_MissCR_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_FaCR_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnFaCrFig)
fprintf("Saved tone(stim)-aligned dff plot comparing Miss vs CR!\n")
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); %ylim([-.3 .3])
print(fullfile(filePath, 'Figure', strcat('dff_postStimLick_Gng_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
print(fullfile(filePath, 'Figure', strcat('dff_hitFirstLick_Gng_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(hitFstLickFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_firstWater_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(firstWaterFig)
...
if isfield(rez, 'firstAirpuff')
    ...
    print(fullfile(filePath, 'Figure', strcat('dff_firstAirpuff_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
    close(fstAirFig)
...
print(fullfile(filePath, 'Figure', strcat('dff_faFstLickFig_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(faFstLickFig)
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); grid on
print(fullfile(filePath, 'Figure', strcat('dff_lick_Hit_Fa_postStim_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:.5:4, 'TickDir', 'out', 'YTick', -3:0.1:3); xlim([-1 1]); grid on
print(fullfile(filePath, 'Figure', strcat('dff_lick_Hit_Fa_postStim_baseSub_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
...
clim([-0.5 0.5])
print(fullfile(filePath, 'Figure', strcat('dff_hit_timeBin_by_trial_m1_', channel', '.pdf')), '-dpdf', '-vector', '-bestfit')
close(X_hit_fig)

X_fa_fig = imagescWithTimeInfo(smooth2a(X_fa, 0, 1), rezM1.lickHitFaSvmTs); 
set(gca, 'XTick', -2:.5:4, 'TickDir', 'out');
clim([-0.7 0.7])
print(fullfile(filePath, 'Figure', strcat('dff_fa_timeBin_by_trial_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(X_fa_fig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_goMiss_m1_', channel, '.pdf')), '-dpdf', '-vector', '-bestfit')
close(stimOnMissFig)
...
set(gca, 'TickDir', 'out')
xlabel('Time (s)'); ylabel('DFF'); set(gca, 'XTick', -2:1:5, 'TickDir', 'out', 'YTick', -1:0.1:5); xlim([-1 5]); %ylim([-1 1])
print(fullfile(filePath, 'Figure', strcat('dff_cueOn_nogoCR_m1_', channel, '.pdf'), '-dpdf', '-vector', '-bestfit')
close(stimOnCrFig)
