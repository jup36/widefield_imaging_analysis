function gng_saveEachFrameAsImg(filePath, pethTime, varargin)
...
for t = 1:length(filePathTrials) % trials
    ...
    saveEachFrameAsImage(filePathTrials{t}, fI, frameTrel, frameLickI, frameWaterI, frameAirpuffI)
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function saveEachFrameAsImage(pngPath, pethFrameI, frameTrel, frameLickI, frameWaterI, frameAirpuffI)
        ...
        for f = 1:length(pngs) % frames
            if pethFrameI(f)
                ...
                imgWithText = insertText(img, frameTimePos, frameTimeStr, 'FontSize', 22, 'TextColor', 'white');
