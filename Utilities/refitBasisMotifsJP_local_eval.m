...
filePathTrials = '/Volumes/buschman/Rodent Data/dualImaging_parkj/m1045_jRGECO_GRABda/m1045_122424/task/m1045_122424_trials'; 
...
for chunk = 1:chunkN
    ...
    data_train_org_dir = GrabFiles_sort_trials([fileheader, sprintf('_%d_red', chunk)], 0, filePathImg);
    data_test_org_dir = GrabFiles_sort_trials([fileheader, sprintf('_%d_red', chunk*2)], 0, filePathImg);
