function make_dff_videos_auditory_selectFrames(tbytDat, filePathTrials, frameRate, trials, frameWin)
close all;
...
for t = 1:length(filePathTrials) % trials
    ...
    writeDffVid_timeWin(filePathTrials{t}, vidName, frameRate, frameTrel, frameWin)
    ...
    function writeDffVid_timeWin(pngPath, vidName, frameRate, frameTrel, timeWin)
        ...
        labeledVid = VideoWriter(fullfile(pngPath, [vidName, sprintf('_fr%d', frameRate), 'selectWin', '.mp4']), 'MPEG-4');
