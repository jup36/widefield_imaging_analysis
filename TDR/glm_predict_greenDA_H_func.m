function glm_predict_greenDA_H_func(filePath, fileKeyword)
%% GLM over motif timecourses with robust design construction
% glm_predict_greenDA_H_func(filePath, fileKeyword)
%
% SYNOPSIS
...
%   key = '_refitChunksCurated_green_dff_combined.mat';
%   glm_predict_greenDA_H_func(fp, key);
