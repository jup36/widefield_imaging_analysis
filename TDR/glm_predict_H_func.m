...
%motifs_exclude = [3, 8, 11, 20, 22, 23, 36]; 

%% 1) Stack trials to align H
Hs = stack_trials_H(tbytDat_hAligned, 'zscore', false); % implement as in your decoder'c', 0.8
Ybig = cell2mat(Hs.Yw'); 
...
% lambdaBestR2 = lambdaBest(:, motifR2Id); 
% motifR2IdC = cell(1, numel(motifR2Id)); 
% for kk = 1:length(motifR2Id)
...
% estimate the unique and upper-bound contribution of each predictor with
% temporal shuffling
...
%plot_beta_with_labels(beta, X_names, 18)
