function Data_DualPipeline_GNG_Scotty_func_MotifVerGreenDA_L1(filePathImg, fileKeyword)
...
parameter_class = 'general_params_dual_L1';
...
nChunks = size(fnC, 1); 
[swarm_id, swarm_motifs] = FitMotifs_ScottySwarm_chunks(file_processed, temp_job_id, s_conn, 'general_params_dual_L1', nChunks); %  
