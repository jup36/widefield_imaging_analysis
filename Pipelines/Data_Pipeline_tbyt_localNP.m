...
filePathImg = 'Z:\Rodent Data\Behavioral_dynamics_cj\DA008\DA008_101823\DA008_101823_img'; 
...
for cur_fold = 1:numel(folder_list_raw)
    ...
    % Preprocess
    Local_Preprocessing_Pipeline(file_list_raw{1}, opts_list{1})
    fprintf('Completed preprocessing step 1 for file #%d', cur_fold)
end
...
for cur_fold = 1:numel(folder_list_raw) 
    ...
    Local_CombineStacksBVcorrectTrial(folder_list_raw{cur_fold}, file_list_preprocessed{cur_fold}, 'general_params_example')
    fprintf('Completed preprocessing step 2 for file #%d', cur_fold)
end
