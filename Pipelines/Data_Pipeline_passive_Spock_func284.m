function Data_Pipeline_passive_Spock_func284(filePath, varargin)
...
filePathImg = GrabFiles_sort_trials('_img', 0, {filePath}); %{'/Volumes/buschman/Rodent Data/dualImaging_parkj/m1237_GCAMP/m1237_100224/task/m1237_100224_task_day4_img/tiff_green'}
...
file_list_first_stack = filePathImg(1); % note that each file used to be stored in a separate folder, but now files are saved in a common folder
folder_list_raw = {fileparts(file_list_first_stack)}; 
