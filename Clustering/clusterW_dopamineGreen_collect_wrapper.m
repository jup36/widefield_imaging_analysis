...
mlist = {'m1873', 'm1045', 'm1859', 'm1613', 'm1044', 'm1049'}; 
...
% save
save(fullfile(fileSaveDir, 'clusterW_input_DAmotifs'), 'wC', 'nanpxsC', 'idC', 'skippedFiles', '-v7.3'); % Also backup at '/Volumes/buschman/Rodent Data/dualImaging_parkj/motif_data_backup'
...
save(fullfile(fileSaveDir, 'clusterW_input_DAmotifs'), 'wCV', 'nanpxsCV', 'is_equal_nanpxsC', '-append'); % Also backup at '/Volumes/buschman/Rodent Data/dualImaging_parkj/motif_data_backup'
...
save(fullfile(fileSaveDir, 'clusterW_output_DAmotifs'), 'W_basisC', 'W_aligned', 'kval', 'ovr_q', 'cluster_idxC', 'idx_knn', 'tcorr_mat', 'lag_mat', 'lags', 'nanpxs', 'shiftC', '-v7.3');
